...
import { userPartnerPayRouter } from './user/partnerPay.routes.js';
import { partnerPayRouter } from './partnerPay.routes.js';
...
apiRouter.use('/user/partner-pay', userPartnerPayRouter);
apiRouter.use('/partner-pay', partnerPayRouter);
